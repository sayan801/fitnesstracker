    ...
    <div class="row" >
        <div class="span12" >
            ...
            <div class="well">
                ...
                <center> <h3>Search your result among <br>Highest Degree OR Certification In OR State</h3>
...
?>
        ...
        <div class="span4" >
                ...
                <div class="well">
                    ...
                    <p><a href="index.php?/jobseeker/<?php echo $jobseeker_item['id'] ?>"><input class='btn btn-primary span2' type="button" value="View Candidate &raquo;" /></a> 
                      <a href="#"><input class='btn btn-primary span2' type="button" value="Hire Candidate &raquo;" /></a>
                      </p>
                </div>
            <?php $i++;
                  if($i==3){
